...
\author{Alexandros Filotheou, Antonis Dimitriou, Georgios Sergiadis% <-this % stops a space
...
\section{Problem Formulation}
  ...
  \input{sections/02.problem_formulation/01.problem_formulation.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Definitions}
  \label{section:definitions}
  \input{sections/03.definitions/01.definitions.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Current Solutions}
  \label{section:sota}
  \input{sections/04.current_solutions/01.current_solutions.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The Proposed Method}
  \label{section:the_proposed_method}
  \input{sections/05.the_method/00.the_method.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Experimental Procedure}
  \label{section:experimental}
  \input{sections/06.experiments/00.experiments.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Discussion}
  \label{section:discussion}
  \input{sections/07.discussion/00.discussion.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusions}
  \label{section:finale}
  \input{sections/08.finale/00.finale.tex}
